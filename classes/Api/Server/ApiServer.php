 ...
 * @author Bata Jozsef 
 */
class ApiServer extends RestApiServer
{    
    ...
    public function run()
    {
        ...
        try
        {
            ...
            {
                throw new RestApiException("No endpoint for this api-call", 404);
            }

            if (!file_exists($serviceIncludeFile))
            {
                 throw new RestApiException("Endpoint not implemented", 404);
            }
